...
public:
	...
	// Basic Options:
	const char* GetFindText() const { return m_findText.c_str(); }
	void SetFindText(const char* findText) { m_findText = findText; }
	...
	// Replace Options:
	const char* GetReplaceText() const { return m_replaceText.c_str(); }
	void SetReplaceText(const char* text) { m_replaceText = text; }
	...
	const char* GetFileExts() const { return m_fileExts.c_str(); }
	void SetFileExts(const char* extensions) { m_fileExts = extensions; }
	
	const char* GetSearchPath() const { return m_path.c_str(); }
	void SetSearchPath(const char* path) { m_path = path; }
